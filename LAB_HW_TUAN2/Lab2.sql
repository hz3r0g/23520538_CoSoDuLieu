...
SELECT ChuyenGia_KyNang.MaKyNang, KyNang.TenKyNang, COUNT(MaChuyenGia) AS SoChuyenGia
...
SELECT KyNang.TenKyNang, COUNT(MaChuyenGia) AS SoLuongChuyenGia
